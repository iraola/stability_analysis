...
d_grid = read_data.read_data(excel_sys, create_T_table=True)
d_grid = read_data.read_sys_data(excel_sys)
...
d_grid, d_pf = fill_d_grid_after_powerflow.fill_d_grid(d_grid, GridCal_grid, d_pf, d_raw_data, d_op, clean_d_grid=False)
